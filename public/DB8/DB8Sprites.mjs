...
export async function SPRITES(viewer, selectedFloor) {
    ...
    const myDataList = [
      // first floor
      { position: { x: 791.816162109375 , y: 516.4945068359375 , z: 7.5 }, name: "Main Entrance (DB8.-.1.001)"       ,  pointID: "b957051a-2cb0-4bcb-990c-3c34a6f627a7", assetID:'e2d06cc1-c29d-ef11-8a6b-0022489fd44c', objectDBID: 7432  },
